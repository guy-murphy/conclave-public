...
// Lifted from example of Markdown visitor:-
// http://clariuslabs.github.io/NuDoc/

// its been tidied up and made more complete from the original

namespace Conclave.Documentation.NuDoc.Visitor {
	public class MarkdownVisitor: ClariusLabs.NuDoc.Visitor {
		...
		public override void VisitB(B bold) {
			_builder.AppendFormat("**{0}**", bold.Content);
			base.VisitB(bold);
		}
	}
}
